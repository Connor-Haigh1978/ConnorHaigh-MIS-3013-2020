...
namespace ProcessingCSVFileParticipation
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string filepath = @"C:\Users\conno\Downloads\sales_data_sample.csv";
            ...
            /* if (pieces[6].ToLower() == "shipped" & pieces[8] == "1" & pieces[9] == "2003") ;
             {
                 sum += sale;
                 Console.WriteLine($"The total sales of shipped orders in January 2003 is {sum}");
             } */
